...
- update `../../PROJECT-EXPLAINER/PROMPT_LOG.md`
- update `../../PROJECT-EXPLAINER/PROJECT_STATUS.md`
...
- Platform intent: `../../PROJECT-EXPLAINER/project-explainer.md` (Donations section).
