...
const DEFAULT_ENDPOINT = 'https://libretranslate.com';
...
export async function translateText(text, { source = 'ar', target, endpoint, apiKey } = {}) {
  ...
  const effectiveEndpoint = endpoint || (typeof import.meta !== 'undefined' ? (import.meta.env?.VITE_TRANSLATE_ENDPOINT || DEFAULT_ENDPOINT) : DEFAULT_ENDPOINT);
