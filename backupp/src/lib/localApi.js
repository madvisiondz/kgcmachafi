...
export const adminApi = {
  getSession: async () => request('/api/admin/auth/session.php'),
  login: async (credentials) =>
    request('/api/admin/auth/login.php', {
      method: 'POST',
      body: JSON.stringify(credentials),
    }),
  logout: async () =>
    request('/api/admin/auth/logout.php', {
      method: 'POST',
      body: JSON.stringify({}),
    }),
...
export const contentApi = {
  ...
  getSiteContent: async () => request('/api/public/site-content.php'),
};
