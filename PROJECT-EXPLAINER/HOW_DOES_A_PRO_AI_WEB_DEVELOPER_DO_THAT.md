...
- **Page-specific tracker** for any page touched (e.g. `../TRACKERS/machafi-services/HOMEPAGE_MAP.md`, `../TRACKERS/machafi-services/LIBRARY_PAGE_MAP.md`, `../TRACKERS/machafi-services/PHARMACIES_PAGE_MAP.md`, and future files under `../TRACKERS/machafi-services/` or `../TRACKERS/machafi-tv/`)
