...
export default [
	{ ignores: ['node_modules/**', 'dist/**', 'build/**', 'assets/**', 'vite.config.js'] },
	{
		files: ['**/*.js', '**/*.jsx'],
		...
		languageOptions: {
			...
			globals: { ...normalizeGlobals(globals.browser), React: 'readonly', Intl: 'readonly' },
		},
		settings: {
	...
	{ files: ['tools/**/*.js', 'tailwind.config.js'], languageOptions: { globals: normalizeGlobals(globals.node) } },
];
