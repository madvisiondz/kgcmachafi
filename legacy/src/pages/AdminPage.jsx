...
import LanguagePortal from '@/components/admin/LanguagePortal';
...
const ADMIN_TABS = [
  ...
  { value: 'language-portal', icon: Globe, label: 'بوابة اللغات' },
];
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab}>
          <div className="grid grid-cols-1 lg:grid-cols-[280px_1fr] gap-6 items-start">
            ...
            <div className="min-w-0">
              ...
              {!isEditor && (
                <TabsContent value="language-portal" className="bg-white/5 text-slate-100 p-5 sm:p-6 rounded-3xl shadow-[0_18px_60px_-40px_rgba(0,0,0,0.9)] border border-white/10 mt-0 backdrop-blur-xl">
                  <LanguagePortal />
                </TabsContent>
              )}
            </div>
