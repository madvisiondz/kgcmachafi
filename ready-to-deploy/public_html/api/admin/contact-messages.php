...
if ($method === 'PATCH') {
    ...
    try {
        ...
        api_envelope_error('schema', 'Ensure contact_messages.is_read exists (import database/health_services_schema.sql or run database/health_services_admin_optional.sql).', 500);
    }
