    ...
    <header ref={headerRef} className="fixed top-0 left-0 right-0 z-50 shadow-md flex flex-col min-h-0" dir={dir}>
      ...
      <div className="bg-white border-b relative z-10">
        <div className="container mx-auto px-4">
          <div
            className={`flex flex-col md:flex-row justify-between items-center gap-3 transition-[padding] duration-200 ${
          ...
          >
            <div className="flex items-center w-full md:w-auto gap-3 md:gap-4">
              ...
              <div className="flex items-center gap-2 lg:hidden">
                ...
                <button
                  type="button"
                  className={`rounded-md border border-gray-200 text-gray-700 hover:bg-gray-50 shadow-sm grid place-items-center transition-[width,height] duration-200 ${
                    isCompact ? 'h-8 w-8' : 'h-9 w-9'
                  }`}
      ...
      {/* Mobile menu */}
      {isMenuOpen && (
        <div className="lg:hidden bg-white border-b shadow-xl overflow-hidden">
