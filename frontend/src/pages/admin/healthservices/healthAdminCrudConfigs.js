...
export const programsCrud = {
  ...
  fields: [
    ...
    { key: 'image_url', label: 'Cover image', type: 'upload', uploadCategory: 'programs' },
...
export const booksCrud = {
  ...
  fields: [
    ...
    },
    {
      ...
      label: 'PDF file',
      type: 'uploadPdf',
      uploadCategory: 'books',
      required: true,
      helper: 'Upload a PDF or paste a URL. Use # only as temporary placeholder.',
    },
    { key: 'image_url', label: 'Cover image', type: 'upload', uploadCategory: 'books' },
